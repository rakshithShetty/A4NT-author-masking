...
def save_checkpoint(state, filename='cv/checkpoint.pth.tar'):
...
if __name__ == "__main__":
  ...
  parser.add_argument('--decay_rate', dest='decay_rate', type=float, default=0.995, help='decay rate for adadelta/rmsprop')
